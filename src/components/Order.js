        ...
        <div className='relative rounded-md border'>
            <div className="flex items-center space-x-10 p-5 bg-gray-100 text-sm text-gray-600">
                ...
                <div>
                    ...
                    <p>
                        <Currency quantity={amount} /> - Next Day Delievery {""}
                        <Currency quantity={amountShipping} />
                    </p>
                </div>

                <p className='text-s whitespace-nowrap sm:text-xl self-end flex-1 text-right text-blue-500'>{items.length} items</p>
